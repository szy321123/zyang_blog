...
<div class="equipv2-page">
<div class="equipv2-head" aria-label="我的装备">
<div class="equipv2-head-meta">
<span class="equipv2-head-kicker">Devices</span>
<span class="equipv2-head-title">我的设备清单</span>
</div>
<p class="equipv2-head-desc">这里记录我现在常用的数码设备：能写代码、能上课记笔记、能出门随手用，也能在桌面上安静地提升一点点效率。</p>
<div class="equipv2-head-tags">
<a href="#device-productivity">生产力</a>
<a href="#device-mobile">移动出行</a>
<a href="#device-desktop">桌面外设</a>
</div>
</div>

<div class="equipv2-groups">
<section class="equipv2-group" id="device-productivity">
<div class="equipv2-group-head">
<h2>生产力</h2>
<p>承担开发、学习、阅读和内容处理的主力设备，稳定和屏幕体验优先。</p>
</div>
...
<section class="equipv2-group" id="device-mobile">
<div class="equipv2-group-head">
<h2>移动出行</h2>
<p>日常通信、拍照、音乐和外出场景的高频设备，便携性和稳定性优先。</p>
</div>
<div class="equipv2-grid">
...
<section class="equipv2-group" id="device-desktop">
<div class="equipv2-group-head">
<h2>桌面外设</h2>
<p>每天真正接触最多的输入设备，手感、响应和桌面占用决定了使用频率。</p>
</div>
<div class="equipv2-grid">
